    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: -3.0, end: 15.0),
            Pin(size: 353.0, start: 84.0),
                        ...
                        Pinned.fromPins(
                          ...
                          child: Stack(
                            children: <Widget>[
                              ...
                              Align(
                                alignment: Alignment(-0.476, 0.137),
                                child: SizedBox(
                                  width: 103.0,
                                  height: 16.0,
                                  child: Text(
                        ...
                        Pinned.fromPins(
                          ...
                          child: Stack(
                            children: <Widget>[
                              ...
                              Align(
                                alignment: Alignment(-0.492, 0.137),
                                child: SizedBox(
                                  width: 96.0,
                                  height: 16.0,
                                  child: Text(
                        ...
                        Pinned.fromPins(
                          ...
                          child: Stack(
                            children: <Widget>[
                              ...
                              Align(
                                alignment: Alignment(-0.548, 0.137),
                                child: SizedBox(
                                  width: 66.0,
                                  height: 16.0,
                                  child: Text(
                        ...
                        Pinned.fromPins(
                          ...
                          child: Stack(
                            children: <Widget>[
                              ...
                              Align(
                                alignment: Alignment(-0.567, 0.137),
                                child: SizedBox(
                                  width: 54.0,
                                  height: 16.0,
                                  child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 63.0, end: 15.0),
            Pin(size: 27.0, start: 43.0),
            child: Stack(
              children: <Widget>[
                Align(
...
const String _svg_tw9a4a =
    '<svg viewBox="20.5 254.5 335.0 1.0" ><path transform="translate(20.5, 254.5)" d="M 0 0 L 335 0" fill="none" stroke="#ebebeb" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_sd35 =
    '<svg viewBox="12.0 5.0 1.0 14.0" ><path transform="translate(12.0, 5.0)" d="M 0 0 L 0 14" fill="none" stroke="#ff005c" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_kaj =
    '<svg viewBox="5.0 12.0 14.0 1.0" ><path transform="translate(5.0, 12.0)" d="M 0 0 L 14 0" fill="none" stroke="#ff005c" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg>';

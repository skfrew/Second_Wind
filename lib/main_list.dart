                    ...
                    Pinned.fromPins(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromPins(
                            Pin(size: 213.5, start: 0.5),
                            Pin(size: 16.0, end: 4.0),
                            child: Stack(
                              children: <Widget>[
                                Padding(
                                  padding:
                                      EdgeInsets.fromLTRB(13.5, 0.0, 0.0, 0.0),
                                  child: SizedBox.expand(
                                      child: Text(
                                    'DGIST로부터 약 1시간 30분, 대중교통',
                                    style: TextStyle(
                                      fontFamily: 'Segoe UI',
                                      fontSize: 12,
...
const String _svg_kdboyf =
    '<svg viewBox="40.5 16.5 19.0 19.0" ><path transform="translate(37.5, 14.5)" d="M 3 11 L 22 2 L 13 21 L 11 13 L 3 11 Z" fill="none" stroke="#2b61e2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg>';

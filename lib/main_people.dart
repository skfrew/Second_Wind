    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 336.5, middle: 0.5),
            Pin(size: 555.0, end: 90.0),
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Wrap(
                          ...
                          children: [
                            {
                              'text': '횟집요리사',
                              'text_0': 'DGIST 기초학부, 국내여행주니어',
                              'text_1': '여행경력: 10y',
                              'text_2': 'Age: 21y',
                            },
                            {
                              'text': '프렐요드산눈토끼',
                              'text_0': 'DGIST 기초학부, 일본여행전문가',
                              'text_1': '여행경력: 20y',
                              'text_2': 'Age: 21y',
                            },
                            {
                              'text': '국양총장',
                              'text_0': '전 DGIST 소속, 여행입문자',
                              'text_1': '여행경력: 1y',
                              'text_2': 'Age: 62y',
                            },
                            {
                              'text': '한국아인슈타인',
                              'text_0': '홍익대학교 미술대학 소속, 여행입문자',
                              'text_1': '여행경력: 10y',
                              'text_2': 'Age: 25y',
                            },
                            {
                              'text': '김경민반려인',
                              'text_0': 'DGIST 뇌과학과 소속, 여행주니어',
                              'text_1': '여행경력: 2y',
                              'text_2': 'Age: 23y',
                            },
                            {
                              'text': '디지인 3',
                              'text_0': 'DGIST 교원 소속, 여행전문가',
                              'text_1': '10 min away',
                              'text_2': 'Age: 26y',
                            }
                          ].map((itemData) {
                            ...
                            return SizedBox(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Align(
                                    alignment: Alignment(-0.121, -0.212),
                                    child: SizedBox(
                                      width: 174.0,
                                      height: 16.0,
                                      child: Text(
                                  ...
                                  Align(
                                    alignment: Alignment(-0.426, 0.343),
                                    child: SizedBox(
                                      width: 87.0,
                                      height: 16.0,
                                      child: Stack(
                                  ...
                                  Align(
                                    alignment: Alignment(0.285, 0.343),
                                    child: SizedBox(
                                      width: 46.0,
                                      height: 16.0,
                                      child: Text(
                                  ...
                                  Align(
                                    alignment: Alignment(0.05, 0.341),
                                    child: SizedBox(
                                      width: 10.0,
                                      height: 10.0,
                                      child:
...
const String _svg_m8ex8 =
    '<svg viewBox="4.0 9.7 10.1 3.4" ><path transform="translate(0.0, -5.26)" d="M 14.11187839508057 18.37062644958496 L 14.11187839508057 17.24708366394043 C 14.11187839508057 16.00605392456055 12.98006629943848 15 11.583909034729 15 L 6.527969837188721 15 C 5.131810188293457 15 3.999999523162842 16.00605392456055 4 17.24708366394043 L 4 18.37062644958496" fill="none" stroke="#bebebe" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_ib8ze =
